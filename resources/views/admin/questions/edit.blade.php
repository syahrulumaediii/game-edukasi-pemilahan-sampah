<x-app-layout>
    <x-slot name="header">
        <h2 class="font-fredoka font-semibold text-2xl text-emerald-700 leading-tight">
            {{ __('Edit Soal Default') }}: {{ $question->nama_sampah }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md border border-gray-100">
                <form method="POST" action="{{ route('admin.questions.update', $question) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_sampah" class="block mt-1 w-full" type="text" name="nama_sampah" :value="old('nama_sampah', $question->nama_sampah)" required autofocus placeholder="Contoh: Kulit Pisang, Botol Plastik" />
