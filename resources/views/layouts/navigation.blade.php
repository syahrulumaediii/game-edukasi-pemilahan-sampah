<nav x-data="{ open: false }" class="bg-[#f5faf8] border-b border-emerald-100/40 shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-fredoka font-bold text-sm text-emerald-800 tracking-wide hidden md:block">DETEKTIF SAMPAH</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('guru.sessions.index')" :active="request()->routeIs('guru.sessions.*')">
                            {{ __('Sesi Game') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('guru.sessions.index')" :active="request()->routeIs('guru.sessions.*')">
                    {{ __('Sesi Game') }}
                </x-responsive-nav-link>
            @endif
        </div>
